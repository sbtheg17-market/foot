 ...
 * owner lists, the dashboard/metrics booking rows (bookings.source), and
 * the booking list/detail reads (bookings.source + roadmap-#13 cancellation
 * columns). It simulates a deployed database WITHOUT the frozen Gate B

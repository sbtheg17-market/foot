...
## Summary
- 4272 nodes · 7769 edges · 284 communities (246 shown, 38 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 60 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `daa097bb`
...
1. `cn()` - 273 edges
2. `cn()` - 273 edges
3. `customFetch()` - 92 edges
4. `withQueryKey()` - 45 edges
5. `usersTable` - 41 edges
6. `db` - 41 edges
7. `providerProfilesTable` - 37 edges
8. `scripts` - 35 edges
9. `useColors()` - 34 edges
10. `providerApplicationsTable` - 26 edges
...
- `AvailabilityStep()` --calls--> `useGetApplicationAvailability()`  [EXTRACTED]
  artifacts/mobile/app/onboarding/provider.tsx → lib/api-client-react/src/generated/api.ts
- `ReviewStep()` --calls--> `useSubmitProviderApplication()`  [EXTRACTED]
  artifacts/mobile/app/onboarding/provider.tsx → lib/api-client-react/src/generated/api.ts
- `ServicesStep()` --calls--> `useUpdateApplicationService()`  [EXTRACTED]
  artifacts/mobile/app/onboarding/provider.tsx → lib/api-client-react/src/generated/api.ts
- `AvailabilityStep()` --calls--> `useGetApplicationAvailability()`  [EXTRACTED]
  artifacts/web/src/pages/onboarding/provider.tsx → lib/api-client-react/src/generated/api.ts
...
Cohesion: 0.01
Nodes (240): AcceptRescheduleRequestParams, AcceptRescheduleRequestResponse, AddMyServiceAreaPrefixBody, AddMyServiceAreaPrefixResponse, ApproveProviderApplicationBody, ApproveProviderApplicationParams, ApproveProviderApplicationResponse, CheckBookingPageServiceAreaBody (+232 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (210): AcceptRescheduleRequestMutationError, AcceptRescheduleRequestMutationResult, AddMyServiceAreaPrefixMutationBody, AddMyServiceAreaPrefixMutationError, AddMyServiceAreaPrefixMutationResult, ApproveProviderApplicationMutationBody, ApproveProviderApplicationMutationError, ApproveProviderApplicationMutationResult (+202 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (172): AcceptRescheduleResponse, AddServiceAreaPrefixRequest, AdminProviderApplicationResponse, AdminProviderApplicationView, AdminVerificationQueueItem, AdminVerificationQueueItemProvider, AdminVerificationQueueResponse, ApplicationCompletion (+164 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (87): TxResult, AccountRole, accountRoleEnum, InsertAccountRole, bookingOutcomeActionEnum, BookingOutcomeHistoryRow, bookingOutcomeHistoryTable, InsertBookingOutcomeHistoryRow (+79 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (77): AccordionContent, AccordionItem, AccordionTrigger, Avatar, AvatarFallback, AvatarImage, Card, CardContent (+69 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (69): BOOKING_ATTRIBUTION_SOURCES, BookingAttributionSource, isValidBookingPageSlug(), normalizeBookingSource(), SLUG_MAX_LENGTH, SLUG_MIN_LENGTH, slugCandidate(), slugifyDisplayName() (+61 more)
...
Cohesion: 0.03
Nodes (41): AddServiceAreaPrefixRequest, ApproveProviderApplicationRequest, AvailabilityListResponse, AvailabilitySlot, BadRequestResponse, ConflictResponse, CreateEscalationRequest, CreateRescheduleRequest (+33 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (46): AccountRole, ProviderApplicationState, ROLE_ORDER, RoleState, applicationStatusForProfile(), failPreflight(), ProviderProfileStatus, Role (+38 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (72): customFetch(), isRequest(), resolveMethod(), acceptRescheduleRequest(), checkBookingPageServiceArea(), createBooking(), createProviderApplication(), createRescheduleRequest() (+64 more)

### Community 10 - "Community 10"
Cohesion: 0.05
Nodes (62): apiError(), AvailabilityStep(), DAY_NAMES, DAY_NAMES_FULL, DOC_TYPES, DocType, EMPTY_SERVICE, fmtTime() (+54 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (50): CancellationPolicyNotice(), SupportContactLink(), HookResult, mockContact, baseProps, mockProposal, mockSlots, mockUpdate (+42 more)

### Community 12 - "Community 12"
Cohesion: 0.06
Nodes (35): LoginScreen(), styles, RegisterScreen(), styles, PushNotificationManager(), queryClient, NotFoundScreen(), styles (+27 more)

### Community 13 - "Community 13"
Cohesion: 0.08
Nodes (33): getSecret(), JwtPayload, signToken(), verifyToken(), emitNewBooking(), NewBookingPayload, NotificationBus, NotificationPayload (+25 more)

### Community 14 - "Community 14"
Cohesion: 0.10
Nodes (35): RescheduleModal(), STATUS_STYLES, UpcomingBookings(), AlertDialogAction, AlertDialogCancel, AlertDialogContent, AlertDialogDescription, AlertDialogFooter() (+27 more)

### Community 15 - "Community 15"
Cohesion: 0.06
Nodes (32): ApplicationEventType, createApplicationNotification(), NOTIFICATION_CONTENT, Tx, ActivationEmissionContext, ActivationEventType, emitProviderActivationEvents(), insertEvent() (+24 more)

### Community 16 - "Community 16"
Cohesion: 0.08
Nodes (36): AvailabilityWindow, dayOfWeekForDate(), DEFAULT_MARKETPLACE_TIMEZONE, fieldsMatch(), GeneratedSlot, generateSlotsForDate(), getLocalFields(), getMarketplaceTimezone() (+28 more)

### Community 17 - "Community 17"
Cohesion: 0.10
Nodes (22): AdminProviderApplicationResponse, AdminProviderApplicationView, ApplicationCompletion, ApplicationCompletionResponse, AuthResponse, MeResponse, MeResponseUser, OnboardingState (+14 more)
...
Cohesion: 0.11
Nodes (35): BookingDetailScreen(), formatDate(), STATUS_META, styles, ProviderScreen(), BookingsScreen(), CLIENT_TAB_STATUSES, ClientTab (+27 more)

### Community 21 - "Community 21"
Cohesion: 0.08
Nodes (32): App(), clientRoute(), providerRoute(), queryClient, Router(), LEGACY_PORTAL_REDIRECTS, Discover(), NotFound() (+24 more)

### Community 22 - "Community 22"
Cohesion: 0.05
Nodes (39): devDependencies, chokidar, clsx, cmdk, fast-glob, @radix-ui/react-label, @radix-ui/react-navigation-menu, @radix-ui/react-popover (+31 more)
...
Cohesion: 0.05
Nodes (37): devDependencies, babel-plugin-react-compiler, expo, expo-blur, expo-constants, expo-linking, expo-location, @expo/ngrok (+29 more)
...
Cohesion: 0.06
Nodes (35): scripts, backfill:role-state, build, dev, replay:prevented-bookings, seed, start, test (+27 more)

### Community 29 - "Community 29"
Cohesion: 0.07
Nodes (22): Alert, AlertDescription, AlertTitle, alertVariants, Badge(), BadgeProps, badgeVariants, ButtonGroup() (+14 more)

### Community 30 - "Community 30"
Cohesion: 0.12
Nodes (26): BookingPageCard(), mockGet, mockPublish, mockUnpublish, published, publishMutate, toDataURL, unpublished (+18 more)

### Community 31 - "Community 31"
Cohesion: 0.14
Nodes (23): ClientLayout(), ProviderLayout(), ReadinessChecklist(), ReadinessSummaryCard(), useUnreadCount(), NewBookingEvent, StreamEvent, useProviderNotifications() (+15 more)
...
Cohesion: 0.07
Nodes (28): typescript, devDependencies, prettier, typescript, engines, node, pnpm, typescript (+20 more)

### Community 34 - "Community 34"
Cohesion: 0.09
Nodes (20): EarningsPreview(), PerformanceMetrics(), Tone, TONE_STYLES, QuickActions(), ACTIVITY_META, RecentActivity(), SOURCE_ROWS (+12 more)

### Community 35 - "Community 35"
Cohesion: 0.18
Nodes (17): Button, Empty(), EmptyContent(), EmptyDescription(), EmptyHeader(), EmptyMedia(), emptyMediaVariants, EmptyTitle() (+9 more)
...
Cohesion: 0.12
Nodes (25): ApiError, applyBaseUrl(), AuthTokenGetter, BodyType, buildErrorMessage(), CustomFetchOptions, ErrorType, getMediaType() (+17 more)
...
Cohesion: 0.12
Nodes (16): apiFetch(), fillDraft(), JsonBody, register(), apiFetch(), appFor(), fillDraft(), JsonBody (+8 more)

### Community 47 - "Community 47"
Cohesion: 0.13
Nodes (18): BookingModal(), PROVINCE_CODES, styles, toDateStr(), upcomingDays(), BookingModal(), BookingModalProps, Service (+10 more)

### Community 48 - "Community 48"
Cohesion: 0.10
Nodes (22): DEFAULT_PAGE_LIMIT, MarkCtx, NOTIFICATION_FEED_KEY, UNREAD_COUNT_KEY, useMarkRead(), useNotificationFeed(), getGetProviderNotificationsQueryKey(), getGetProviderNotificationsQueryOptions() (+14 more)
...
Cohesion: 0.17
Nodes (11): BookingPageSettings, MyBookingPageResponse, ProviderApplicationDetail, ProviderApplicationDetailResponse, ProviderApplicationProfile, ProviderListResponse, ProviderProfile, ProviderProfileResponse (+3 more)
...
Cohesion: 0.11
Nodes (19): dependencies, bcryptjs, cookie-parser, cors, expo-server-sdk, express, jsonwebtoken, pino (+11 more)

### Community 59 - "Community 59"
Cohesion: 0.15
Nodes (11): api(), createBooking(), login(), patchStatus(), propose(), api(), createBooking(), login() (+3 more)
...
Cohesion: 0.12
Nodes (18): PortalServiceArea(), addMyServiceAreaPrefix(), getAddMyServiceAreaPrefixMutationOptions(), getAddMyServiceAreaPrefixUrl(), getGetMyServiceAreaQueryKey(), getGetMyServiceAreaQueryOptions(), getGetMyServiceAreaUrl(), getMyServiceArea() (+10 more)

### Community 64 - "Community 64"
Cohesion: 0.12
Nodes (18): PortalTravelZones(), createTravelZone(), deleteTravelZone(), getCreateTravelZoneMutationOptions(), getCreateTravelZoneUrl(), getDeleteTravelZoneMutationOptions(), getDeleteTravelZoneUrl(), getGetMyProviderReadinessQueryKey() (+10 more)
...
Cohesion: 0.16
Nodes (13): ClientReviewForm(), ExistingReview, InputGroup(), InputGroupAddon(), inputGroupAddonVariants, InputGroupButton(), inputGroupButtonVariants, InputGroupInput() (+5 more)
...
Cohesion: 0.14
Nodes (13): @workspace/db, dependencies, @workspace/db, @workspace/db, name, private, scripts, hello (+5 more)
...
Cohesion: 0.21
Nodes (8): EligibilityResult, Props, ServiceAreaCheck(), ServiceAreaSummary, STATUS_PRESENTATION, CANADIAN_PROVINCES, SERVICE_AREA_UNAVAILABLE_MESSAGE, useCheckBookingPageServiceArea()
...
Cohesion: 0.25
Nodes (9): apiFetch(), bookingPayload(), createBooking(), loadSlotPool(), login(), RecordRow, rowsForSlot(), slotPool (+1 more)
...
Cohesion: 0.24
Nodes (8): DEFAULT_MARKETPLACE_ID, DEFAULT_MARKETPLACE_SLUG, appendToDlqBestEffort(), PREVENTED_BOOKING_FAILURE_EVT, PreventedBookingEvent, PreventedBookingFailurePayload, PreventedBookingPath, recordPreventedBooking()
...
Cohesion: 0.43
Nodes (4): getSupportContact(), InvalidSupportContactError, SUPPORT_CONTACT_PLACEHOLDER_EMAIL, SupportContact
...
Cohesion: 0.50
Nodes (4): getGetMyAvailabilityQueryKey(), getGetMyAvailabilityQueryOptions(), getGetMyAvailabilityUrl(), getMyAvailability()
...
Cohesion: 0.50
Nodes (4): getGetProviderApplicationCompletionQueryKey(), getGetProviderApplicationCompletionQueryOptions(), getGetProviderApplicationCompletionUrl(), getProviderApplicationCompletion()

### Community 178 - "Community 178"
Cohesion: 0.50
Nodes (4): getGetProviderApplicationQueryKey(), getGetProviderApplicationQueryOptions(), getGetProviderApplicationUrl(), getProviderApplication()
...
Cohesion: 0.67
Nodes (3): @workspace/api-client-react, @workspace/api-client-react, @workspace/api-client-react
...
## Knowledge Gaps
- **1420 isolated node(s):** `AcceptRescheduleRequestMutationError`, `AcceptRescheduleRequestMutationResult`, `AddMyServiceAreaPrefixMutationBody`, `AddMyServiceAreaPrefixMutationError`, `AddMyServiceAreaPrefixMutationResult` (+1415 more)
...
- **Why does `cn()` connect `Community 4` to `Community 35`, `Community 134`, `Community 103`, `Community 71`, `Community 41`, `Community 72`, `Community 109`, `Community 14`, `Community 19`, `Community 85`, `Community 86`, `Community 91`, `Community 29`, `Community 126`, `Community 127`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `CreateReviewBody` connect `Community 0` to `Community 13`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `devDependencies` connect `Community 24` to `Community 22`, `Community 81`, `Community 158`, `Community 159`, `Community 160`, `Community 73`, `Community 204`, `Community 205`, `Community 77`, `Community 206`, `Community 208`, `Community 207`, `Community 209`, `Community 210`, `Community 211`, `Community 212`, `Community 213`, `Community 214`, `Community 216`, `Community 217`, `Community 218`, `Community 215`, `Community 219`, `Community 220`, `Community 221`, `Community 222`, `Community 223`, `Community 224`, `Community 225`, `Community 226`, `Community 227`, `Community 228`, `Community 229`, `Community 230`, `Community 231`, `Community 232`, `Community 233`, `Community 234`, `Community 235`, `Community 236`, `Community 237`, `Community 238`, `Community 239`, `Community 240`, `Community 241`, `Community 242`, `Community 243`, `Community 244`?**
...
- **Should `Community 1` be split into smaller, more focused modules?**
  _Cohesion score 0.01002031144211239 - nodes in this community are weakly interconnected._

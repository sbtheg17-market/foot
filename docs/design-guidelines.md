...
> **Source note (Aug 2026):** Extracted from the pre-Replit conflict branch (`conflict_310726_2216`). Design tokens, palette, typography, and component rules are fully adopted in the current TypeScript/Vite stack. References to `frontend/src/index.css` map to `artifacts/web/src/index.css` in the current monorepo.
